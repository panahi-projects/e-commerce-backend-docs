...
export default defineConfig({
  ...
  themeConfig: {
    nav: [
      ...
      {
        text: 'API (Swagger)',
        link: 'https://panahi-projects.liara.run/api/v1/docs',
        target: '_blank',
      },
    ],
    ...
    sidebar: {
      ...
      '/developer/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Creating a Plugin', link: '/developer/plugins/creating-a-plugin' },
            { text: 'Feature Flags API', link: '/developer/plugins/feature-flags' },
            { text: 'Plugin Registry', link: '/developer/plugins/plugin-registry' },
            {
              text: 'Existing Plugins',
              collapsed: true,
              items: [
                { text: 'Coupons', link: '/developer/plugins/existing-plugins/coupons' },
                { text: 'Reviews', link: '/developer/plugins/existing-plugins/reviews' },
                {
                  text: 'Compare Products',
                  link: '/developer/plugins/existing-plugins/compare-products',
                },
                { text: 'Wishlist', link: '/developer/plugins/existing-plugins/wishlist' },
                { text: 'Marketing', link: '/developer/plugins/existing-plugins/marketing' },
                { text: 'Analytics', link: '/developer/plugins/existing-plugins/analytics' },
                {
                  text: 'Loyalty Points',
      ...
      '/deployment/': [
        ...
        },
        {
          text: 'Linux VPS',
          items: [
            { text: 'Generic Ubuntu/Debian VPS', link: '/deployment/ubuntu-debian-vps' },
        ...
        },
        {
          text: 'Portable',
          items: [
            { text: 'Docker Compose (any host)', link: '/deployment/docker-compose' },
            { text: 'Windows Server / Docker Desktop', link: '/deployment/windows-server' },
          ],
        },
      ],
    },
